...
public class Probabilities extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Αν σε κάποια χώρα η αναλογία φύλου στον πληθυσμό ξεφέυγει, επειδή η πιθανότητα θανάτου δεν επηρεάζεται υπερβολικά
        // από το φύλλο, θα βάλουμε τη ρίζα του sex ratio καθώς είναι πιο αντιπροσωπευτηκή. Για τις χώρες που η αναλογία είναι κοντά στο 1,
        // δεν επηρεάζει σχεδόν καθόλου η ρίζα οπότε δεν υπάρχει θέμα.
    ...
    float getDeathProbability(float countryDeathRate,float worldDeathRate,float ageDeathRate,float sexDeathRatio, float diseaseDeathRate){
        ...
        // Δοκίμασα πάρα πολλούς συνδυασμούς και ειδικά συνδυασμούς που τείνουν σε μεγάλα νούμερα και κανένα δεν προσέγγιζε το 100. Αν κάποιος συνδυασμός
        // ξεπερνάει το 100 για κάποιο λόγο τότε το βάζουμε να δείχνει 98-99%.
